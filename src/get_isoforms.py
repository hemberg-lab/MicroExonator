...
def main(annotation_bed12, annotation_gtf, out_filtered_ME, chrM):
    ...
    with open(annotation_bed12) as F:
        ...
        for row in reader:
            chrom, start, end, transcript, score, strand, trickStart, trickEnd, score2, blocknumber, blocksizes, qstarts = row
    ...
    with open(out_filtered_ME) as F:
        ...
        for row in reader:
            ...
            chrom, starnd, start, end = row["ME"].split("_")
            ...
            if transcript_id in transcript_to_gene:
                ...
                for q1, q2, b in zip(qstarts, qstarts[1:], blocksizes):
                    ...
                    if (chrom, eend, strand) in ME_starts:
                        ...
                        ME = ME.split("_")
                        ME_chrom, ME_strand, ME_start, ME_end  = ME
...
if __name__ == '__main__':
	main(sys.argv[1], sys.argv[2], sys.argv[3], str2bool(sys.argv[3]))
