...
ME_number_files_detected <- fread(snakemake@input[["ME_coverage"]])
...
ME_final[ME_P_value > P_ME_fit & mean_conservations_vertebrates>=snakemake@params[["min_conservation"]], ME_type:="RESCUED"]
