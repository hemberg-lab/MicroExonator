...
```{r}
GABA_gluta.tasic <- fread("/Users/gp7/Google_Drive/Results/ME/Single_cell/BetaDist/Sig_nodes/GABA-ergic_Neuron_vs_Glutamatergic_Neuron.txt")

View(GABA_gluta.tasic[Type=="CE", ])
